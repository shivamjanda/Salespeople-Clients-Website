...
/*
I used a acceptable use policy generator from this website to get the html template of the code below: https://app.websitepolicies.com/
*/
?>
<!-- I used a acceptable use generator from this website to get the html template of the code below:https://app.websitepolicies.com/ -->

<h1>Acceptable Use Policy for Shivs Website</h1>

<h1>Acceptable use policy</h1>
<p>This acceptable use policy (&#8220;Policy&#8221;) sets forth the general guidelines and acceptable and prohibited uses of the <a href="https://opentech.durhamcollege.org/webd3201/jandas/lab4/" class="text-dark">opentech.durhamcollege.org/webd3201/jandas/lab4/</a> website (&#8220;Website&#8221; or &#8220;Service&#8221;) and any of its related products and services (collectively, &#8220;Services&#8221;). This Policy is a legally binding agreement between you (&#8220;User&#8221;, &#8220;you&#8221; or &#8220;your&#8221;) and this Website operator (&#8220;Operator&#8221;, &#8220;we&#8221;, &#8220;us&#8221; or &#8220;our&#8221;). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms &#8220;User&#8221;, &#8220;you&#8221; or &#8220;your&#8221; shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Website and Services. By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Agreement. You acknowledge that this Agreement is a contract between you and the Operator, even though it is electronic and is not physically signed by you, and it governs your use of the Website and Services.</p>
<div class="wpembed-index" class="text-dark"><h3>Table of contents</h3><ol class="wpembed-index"><li><a href="#prohibited-activities-and-uses" class="text-dark">Prohibited activities and uses</a></li><li><a href="#system-abuse"class="text-dark">System abuse</a></li><li><a href="#service-resources" class="text-dark">Service resources</a></li><li><a href="#no-spam-policy" class="text-dark">No spam policy</a></li><li><a href="#defamation-and-objectionable-content" class="text-dark">Defamation and objectionable content</a></li><li><a href="#copyrighted-content" class="text-dark">Copyrighted content</a></li><li><a href="#security" class="text-dark">Security</a></li><li><a href="#enforcement" class="text-dark">Enforcement</a></li><li><a href="#reporting-violations" class="text-dark">Reporting violations</a></li><li><a href="#changes-and-amendments" class="text-dark">Changes and amendments</a></li><li><a href="#acceptance-of-this-policy" class="text-dark">Acceptance of this policy</a></li><li><a href="#contacting-us" class="text-dark">Contacting us</a></li></ol></div><h2 id="prohibited-activities-and-uses" class="text-dark">Prohibited activities and uses</h2>
...
<p>You take full responsibility for maintaining reasonable security precautions for your account. You are responsible for protecting and updating any login account provided to you for the Website and Services.</p>
...
<p><a href="&#109;&#097;&#105;&#108;&#116;&#111;&#058;&#115;h&#105;&#118;am.&#106;a&#110;da&#64;&#100;cm&#97;i&#108;.&#99;a">&#115;hiv&#97;&#109;&#46;jand&#97;&#64;&#100;cm&#97;il&#46;&#99;a</a></p>
<p>This document was last updated on December 8, 2022</p>
